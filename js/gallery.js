			...
			$(function() {
				...
				var current				= 0;
				//current image being viewed's name
				var current_name		= '';
				...
				function openGallery($gallery){
					...
					*/
					...
					$fp_content_wrapper.find('.content')
						...
						current_name	= $current.find('img').attr('alt').split("/").pop().split(".")[0];
						$fp_details.text(current_name);
...
/*
			...
			//Selects the 6th item from the list upon navigating to this page
				$("#fp_galleryList > li:nth-child(6)").click();
						});	
*/			
			$(document).ready(function(){
/* 				console.log("documant is ready"); */
			$("#cookies").waitForImages().done(function(){
/* 				console.log("wait is done"); */
				$("#fp_galleryList > li:nth-child(1)").click();
