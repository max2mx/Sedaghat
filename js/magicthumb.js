...
var MagicThumb = (function(c) {
    ...
    var a = new c.Class({
        ...
        init: function(e, f) {
            ...
            this.t29 = (this.t29 = c.win.j29("magicthumb:holder")) ? this.t29 : c.win.j29("magicthumb:holder", c.$new("div").j2("magicthumb-hidden-wrapper").j6({
                position: "absolute",
                top: -10000,
                width: 10,
                height: 10,
            ...
            if ((" " + this.r.className + " ").match(/\s(MagicThumb|MagicZoomPlus)\s/)) {
                if (c.j21.ieMode) {
                    this.r.j2("magic-for-ie" + c.j21.ieMode)
                }
        ...
        stop: function(e) {
            ...
            if (this.t22) {
                if (this.t22.j29("j24:external-click")) {
                    c.doc.je2("click", this.t22.j29("j24:external-click"));
                    c.j21.touchScreen && c.doc.je2("touchstart", this.t22.j29("j24:external-click"))
                }
        ...
        t7: function() {
            ...
            this.t22.j30("j24:external-click", _dch = function(i) {
                if (this.t22.hasChild(i.getTarget())) {
                    return
                }
                if ((/touch/i).test(i.type) || ((1 == i.getButton() || 0 == i.getButton()) && "expanded" == this.state)) {
                    this.restore(null)
                }
            }.j16(this));
            c.doc.je1("click", _dch);
            c.j21.touchScreen && c.doc.je1("touchstart", _dch)
        },
        t8: function() {
